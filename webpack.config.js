...
module.exports = {
    ...
    output: {                                    
        path: path.resolve(__dirname, 'dist'),   //output that bundled code to a folder that we specify. It is common and best practice to put your bundled code into a folder named dist
